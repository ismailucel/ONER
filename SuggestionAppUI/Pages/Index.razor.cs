 ...
 public partial class Index
 {
     ...
     private async Task VoteUp(SuggestionModel suggestion)
     {
         if (loggedInUser is not null)
         {
             ...
             // UserVotes is a hashSet and cannot have duplicate values. It's gonna return false if you are trying to upvote more than once. It will remove the upvote.
             // Does it locally
         ...
         {
             navManager.NavigateTo("/MicrosoftIdentity/Account/SignIn", true); //takes you to login page if you are not signed in
         }
     }
     ...
     private string GetSuggestionStatusClass(SuggestionModel suggestion)
     {
         ...
         string output = suggestion.SuggestionStatus.StatusName switch
         {
             ...
             "Testing&Integration" => "suggestion-entry-status-watching",
             "Implementation" => "suggestion-entry-status-watching",
             "Design" => "suggestion-entry-status-watching",
             "Analysis" => "suggestion-entry-status-watching",
             "Planing" => "suggestion-entry-status-watching",
             "Upcoming" => "suggestion-entry-status-upcoming",
             "Watching" => "suggestion-entry-status-upcoming",
